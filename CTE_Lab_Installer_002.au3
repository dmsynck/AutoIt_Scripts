; Filename: CTE_Lab_Installer_002.au3
...
Func Run_Opening_Splash()
    ...
    "Last Updated: October 12, 2017" & @LF & "Coded by: username <username@no_reply.net>")
