; Filename: 2017_CAD_Lab_Install.au3
; Coded by: David M. Synck <username@email_address.net>
; Last File Change: 20 May 2016
; Purpose: To enable installation of 2017 Autodesk software for CAD labs
...
Const $server_share = "\\server\share"
Const $domain = "domain"
Const $map_drive = "X:"
...
Global $temp_dir = "C:\gisd\install\"
...
Func RunOpeningSplash()
    ...
    Local $sMessage_1 = StringAddCR("Autodesk 2017 CAD Lab Installer" & @LF & "May, 2016" & @LF & "Coded by: David M. Synck <username@email_address.net")
...
;RunWait(@ComSpec & " /c Reg Import C:\gisd\install\Disable_MC3.reg")
